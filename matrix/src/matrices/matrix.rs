...
impl<F:'static+Clone+Zero+Mul<Output=F>, const N:usize> Pow2 for Matrix<F,N,N> {
...
pub type RightTriangularMatrix  <F,const M:usize, const N:usize>=matrix_wrappers::RightTriangular<Matrix<F,M,N>>;

pub type OrthogonalMatrix       <F,const N:usize>=matrix_wrappers::Orthogonal       <Matrix<F,N,N>>;
