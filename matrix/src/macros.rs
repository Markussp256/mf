...
//         ($name:ident $(, $tr:ident)?) => {
//         impl<M:matrix_traits::MatrixViewSquare> matrix_traits::AsSquareMatrix for $name<M> $(where M::F : $tr)? {
//             type Output=M;
//             fn square(&self) -> &M {
//                &self.0
//             }
...
//         impl<M:matrix_traits::MatrixViewSquare> matrix_traits::IntoSquareMatrix for $name<M> $(where M::F : $tr)? {
//             type Output=M;
...
//         }
        ...
        // impl<M:matrix_traits::MatrixViewSquare> matrix_traits::AsMatrix for $name<M> $(where M::F : $tr)? {
        ...
        // impl<M:matrix_traits::MatrixViewSquare> matrix_traits::IntoMatrix for $name<M>$(where M::F : $tr)? {
