...
use matrix_traits::{Matrix, MatrixConstructError, MatrixViewNotWide, MatrixTryConstruct, MatrixView, Transpose, TryFromMatrix};
...
#[derive(Clone,
         ...
         matrix_derive::MatrixViewNotTall,
         matrix_derive::MatrixViewSquare,
         matrix_derive::MatrixViewTall,
         matrix_derive::PopCol,
)]
pub struct NotWide<M:MatrixView>(M);

impl<M:MatrixView> MatrixViewNotWide for NotWide<M> {}
